## this is one of the solution of the leetcode problem. this solution does not use the built-in split method to find the wordsin the string.
## it beats 100% of the solution.
def reverseWords(s):
        length = len(s)
        ...
        return ' '.join(result)
print(reverseWords("My Name is  Abhishek "))
